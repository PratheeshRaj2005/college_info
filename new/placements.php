...
if ($college_id) {
    $sql = "
        SELECT 
            ...
            placements.minimum_package,
              placements.placement_rate,
               placements.participated_students,
            placements. accepted_offers,
            placements. total_recruiters,
                 placements.company_logos,   
        ...
        LEFT JOIN 
            colleges 
        ON 
            placements.college_name = colleges.college_name
        WHERE 
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "
                            <tr><td>Average Package</td><td>" . $row['average_package'] . " LPA</td></tr>
                            <tr><td>Minimum Package</td><td>" . $row['minimum_package'] . " LPA</td></tr>
                            <tr><td>Placement Rate</td><td>" . $row['placement_rate'] . "%</td></tr>
                            <tr><td>Participated Students</td><td>" . $row['participated_students'] . "</td></tr>
                            <tr><td>Accepted Offers</td><td>" . $row['accepted_offers'] . "</td></tr>
                            <tr><td>Total Recruiters</td><td>" . $row['total_recruiters'] . "</td></tr>
                        ";
                    }
                } else {
